...
import { Home, Users, UserPlus, CheckCircle, AlertCircle } from "lucide-react";
...
export default function GestorCadastroAlunos() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage({ type: 'error', text: data.message || 'Erro ao criar conta do aluno' });
      }
    } catch (error) {
    ...
    <div className="dashboard">
      ...
      <aside className="sidebar">
        <div>
          ...
          <nav className="nav">
            ...
            <Link to="/gestor/cadastro-alunos" className="active"><UserPlus size={18}/> Cadastrar Alunos</Link>
      ...
      <main className="main">
        <div className="content">
          <div className="titulo">Cadastrar Novo Aluno</div>
          ...
          <div className="caixa">
            <div className="subtitulo">Dados do Aluno</div>
            ...
            <form className="form" onSubmit={handleSubmit}>
              ...
              <div className="field">
                <label className="label" htmlFor="turmaId">Turma *</label>
                <select
                  id="turmaId"
                  name="turmaId"
                  className="select"
              ...
              <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
                ...
                <button
                  ...
                  disabled={submitting}
                >
                  {submitting ? 'Criando...' : 'Criar Conta do Aluno'}
                </button>
              </div>
            </form>
          </div>
          ...
          <div className="caixa">
            ...
            <ul style={{ margin: 0, paddingLeft: '20px', color: 'var(--muted)' }}>
              <li>O aluno receberá acesso imediato ao sistema</li>
              <li>Será automaticamente vinculado à turma selecionada</li>
              <li>Poderá acessar atividades e materiais da turma</li>
              <li>Você pode criar quantos alunos precisar</li>
            </ul>
          </div>
        </div>
      </main>
